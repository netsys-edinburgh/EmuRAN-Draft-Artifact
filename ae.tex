...
\makeatletter
\renewcommand\section{\@startsection{section}{1}{0pt}{1.0ex}{0.35ex}{\normalsize\bfseries}}
\renewcommand\subsection{\@startsection{subsection}{2}{0pt}{0.7ex}{0.25ex}{\normalsize\bfseries}}
...
The repository includes \href{https://github.com/netsys-edinburgh/EmuRAN-Draft-Artifact/blob/main/chronos-artifact.mp4}{\code{chronos-artifact.mp4}},
...
\noindent\code{git clone }\url{https://github.com/netsys-edinburgh/EmuRAN-Draft-Artifact.git}\\
\code{cd EmuRAN-Draft-Artifact}

The repository is available at
\href{https://github.com/netsys-edinburgh/EmuRAN-Draft-Artifact}{Chronos artifact GitHub repository}.
...
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.29\columnwidth}>{\raggedright\arraybackslash}p{0.65\columnwidth}@{}}
\toprule
Path & Purpose \\
\midrule
\path{code/supervisor/} & Patched Linux 5.15/KVM source.  The virtualized TSC allows guest time to be advanced or paused independently of wall-clock time. \\
\path{code/slot_monitor/} & The \code{custom\_tsc} kernel module, shared-memory support, and slot-monitor utilities used to control virtual time. \\
\path{code/middlebox/} & Modified multi-UE nFAPI proxy.  It forwards traffic, tracks local slot completion, and communicates with the global slot coordinator. \\
\path{code/gnb/} & Modified OpenAirInterface gNB source, operated in nFAPI VNF/emulated-L1 mode. \\
\path{code/ue/} & Modified OpenAirInterface UE source, operated in standalone nFAPI PNF/emulated-L1 mode. \\
\bottomrule
\end{tabular}
...
The video tutorial \href{https://github.com/netsys-edinburgh/EmuRAN-Draft-Artifact/blob/main/chronos-artifact.mp4}{\code{chronos-artifact.mp4}}
demonstrates the complete Powder evaluation workflow.
...
the value for scale 200, run \code{./teardown-experiment.sh} once more and log
