...
The expected nodes should report \code{Ready}, and the provided Chronos pods
...
\subsection{Step 3: observe Chronos operation}
...
\begin{itemize}
  \item Kubernetes reports the expected nodes as \code{Ready} and the Chronos
...
pace with real time; a factor above 1 means Chronos is deliberately allowing
