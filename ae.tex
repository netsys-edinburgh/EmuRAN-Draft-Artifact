...
The repository includes \href{run:chronos-artifact.mp4}{\code{chronos-artifact.mp4}},
...
The video tutorial \href{run:chronos-artifact.mp4}{\code{chronos-artifact.mp4}}
